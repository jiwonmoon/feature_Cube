...
namespace F_test
{
	...
	public:
		...
		void compare2img(const vector<Mat> img_set, const int idx1, const int idx2, const Mat mask, int typeOfFeature, int match_type);
	...
	protected:
		...
		double Avg_HAMMING(const Mat desc1, const Mat desc2);
